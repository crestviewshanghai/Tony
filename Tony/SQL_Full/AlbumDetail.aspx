<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlbumDetail.aspx.cs" Inherits="AlbumDetail" %>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-9" id="rightBox">
                <div class="col-sm-12 col-md-12 pad">
                    <div class="positionBox">
                        ...
                        <span>
                            <a href="./">首页</a>
                             > 
                            <asp:HyperLink ID="hlTitle" runat="server" Text="图片中心"></asp:HyperLink>
                        </span>
                    </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-12 pad">
                    ...
                    <div id="ContentDiv" runat="server" class="detailParameter"></div>
                </div>
