...
public partial class Admin_Express_List : MojoCube.Api.UI.MyPage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ((Label)e.Row.FindControl("lblType")).Text = MojoCube.Web.Sys.TypeID.GetTypeName("Express_List", ((Label)e.Row.FindControl("lblType")).Text, "CHS");
