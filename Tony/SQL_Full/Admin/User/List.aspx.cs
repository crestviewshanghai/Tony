...
public partial class Admin_User_List : MojoCube.Api.UI.MyPage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (((Label)e.Row.FindControl("lblThumbnail")).Text != "")
            {
                ...
                ((Label)e.Row.FindControl("lblThumbnail")).Text = "<a href=\"" + imgPath + "\" class=\"fancybox fancybox.image\" data-fancybox-group=\"gallery\" title=\"" + ((Label)e.Row.FindControl("lblFullName")).Text + "\"><img src=\"" + imgPath + "&cut=50,50\" class=\"img-circle\" style=\"width:25px; height:25px;\" /></a>";
            }
            else
            {
            ...
            {
                ((Label)e.Row.FindControl("lblWages")).Text = decimal.Parse(((Label)e.Row.FindControl("lblWages")).Text).ToString("N2");
            }
