<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Admin_Download_Edit" %>
                        ...
                        <div class="active tab-pane" id="info">
                            <div class="box-body">
                              ...
                              <div class="col-md-6" style="padding:0;">
                                <label><asp:Label ID="Label8" runat="server" Text="文件"></asp:Label></label>
                                <div class="showimg">
                                    <asp:Image ID="imgMain" runat="server" Visible="false"></asp:Image>
                                    <div class="showimg-del">
                                        <asp:LinkButton ID="lnbRemoveFile" runat="server" onclick="lnbRemoveFile_Click" OnClientClick="{return confirm('确定删除文件吗？');}" Visible="false"><span class="label label-danger"><i class="fa fa-remove"></i> 移除</span></asp:LinkButton>
                                    </div>
                                </div>
                                <div class="form-group">
