...
public partial class Admin_System_Menu : MojoCube.Api.UI.MyPage
{
    ...
    protected void lnbSearch_Click(object sender, EventArgs e)
    {
        ...
        GridBind("Name_CHS like '%" + keyword + "%'");
    }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            MojoCube.Web.Sql.SetSortID("Sys_Menu", "pk_Menu", ((Label)GridView1.Rows[index].FindControl("lblID")).Text, -1);
        }
        //下移
