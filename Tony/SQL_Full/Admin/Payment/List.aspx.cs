...
public partial class Admin_Payment_List : MojoCube.Api.UI.MyPage
{
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ((Label)e.Row.FindControl("lblType")).Text = MojoCube.Web.Sys.TypeID.GetTypeName("Payment_List", ((Label)e.Row.FindControl("lblType")).Text, "CHS");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            index = Convert.ToInt32(e.CommandArgument);
            MojoCube.Web.Sql.SetSortID("Payment_List", "pk_Payment", ((Label)GridView1.Rows[index].FindControl("lblID")).Text, -1);
        }
        //下移
