...
public partial class Admin_Member_Online : MojoCube.Api.UI.MyPage
{
    ...
    private void GridBind()
    {
        ...
        pager.TableName = "View_Member_Online";
        pager.strGetFields = "*";
        ...
        if (txtKeyword.Text.Trim() != "")
        {
            ...
            where += "(FirstName like '%" + keyword + "%' or LastName like '%" + keyword + "%' or IPAddress like '%" + keyword + "%')";
        }
