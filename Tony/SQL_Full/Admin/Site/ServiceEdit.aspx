<%@ Page Language="C#" MasterPageFile="../Commons/Main.master" AutoEventWireup="true" CodeFile="ServiceEdit.aspx.cs" Inherits="Admin_Site_ServiceEdit" %>
          ...
          <div class="box box-default">
            ...
            <div class="box-body">
              <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                    <label><asp:Label ID="Label3" runat="server" Text="代码"></asp:Label></label>
