                ...
                <div class="positionBox">
                    <div class="titleBar">
                        ...
                        <span>
                            <a href="./">首页</a>
                             > 
                            <asp:HyperLink ID="hlTitle" runat="server" Text="重新发送确认邮件"></asp:HyperLink>
                        </span>
                    </div>
                </div>
                    ...
                    <table cellpadding="3" cellspacing="5" class="reg">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="btnSubmit" runat="server" Text="发送" CssClass="btn" onclick="btnSubmit_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
