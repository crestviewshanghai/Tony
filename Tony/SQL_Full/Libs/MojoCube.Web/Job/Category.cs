...
namespace MojoCube.Web.Job
{
    public class Category
    {
        ...
        public void GetData(int id)
        {
            ...
            {
                conn.Open();
                string sql = "select * from Job_Category where pk_Category=@pk_Category";
        ...
        public void GetData(string pageName)
        {
            ...
            {
                conn.Open();
                string sql = "select * from Job_Category where PageName=@PageName";
                SqlCommand comm = new SqlCommand(sql, conn);
        ...
        {
            Sql.SqlQuery("delete from Job_Category where pk_Category=" + id);
        }
