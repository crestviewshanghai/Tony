...
namespace MojoCube.Web.Album
{
    public class Image
    {
        ...
        public void GetData(int id)
        {
            ...
            {
                conn.Open();
                string sql = "select * from Album_Image where pk_Image=@pk_Image";
                ...
                if (dr.Read())
                {
                    ...
                    _fk_Album = Convert.ToInt32(dr["fk_Album"].ToString());
        ...
        public int InsertData()
        {
            ...
            {
                conn.Open();
                string sql = "insert into Album_Image(fk_Album,FileName,FilePath,FileType,FileSize,Width,Height,Title,SortID,Visible,CreateDate,CreateUserID,ModifyDate,ModifyUserID,Language) values (@fk_Album,@FileName,@FilePath,@FileType,@FileSize,@Width,@Height,@Title,@SortID,@Visible,@CreateDate,@CreateUserID,@ModifyDate,@ModifyUserID,@Language)";
                SqlCommand comm = new SqlCommand(sql, conn);
                comm.Parameters.Add(new SqlParameter("@fk_Album", SqlDbType.Int));
                comm.Parameters["@fk_Album"].Value = _fk_Album;
        ...
        {
            Sql.SqlQuery("delete from Album_Image where pk_Image=" + id);
        }
