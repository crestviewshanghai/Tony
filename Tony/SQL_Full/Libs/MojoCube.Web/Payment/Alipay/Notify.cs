...
namespace MojoCube.Web.Payment.Alipay
{
    ...
    public class Notify
    {
        ...
        public Notify(ArrayList inputPara, string notify_id, string partner, string key, string input_charset, string sign_type, string transport)
        {
            ...
            sPara = Function.Para_filter(inputPara);  //过滤空值、sign与sign_type参数
