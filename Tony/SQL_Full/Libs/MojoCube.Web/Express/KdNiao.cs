...
namespace MojoCube.Web.Express
{
    public class KdNiao
    {
        ...
        public string getOrderTracesByJson()
        {
            ...
            param.Add("EBusinessID", AppID);
            param.Add("RequestType", "1002");
            string dataSign = encrypt(requestData, KeyCode, "UTF-8");
            param.Add("DataSign", HttpUtility.UrlEncode(dataSign, Encoding.UTF8));
            param.Add("DataType", "2");

            string result = sendPost(Gateway, param);
        ...
        public static string GetContent(string content)
        {
            ...
            try
            {
                string str = jos["Traces"].ToString();
                JArray ja = (JArray)JsonConvert.DeserializeObject(str);
                foreach (JObject o in ja)
                {
                    content += "<div class='express'>" + o["AcceptStation"] + "<span>【" + o["AcceptTime"] + "】</span></div>";
                }
            }
            catch { }
            return content;
        ...
        public static DataTable GetDT(string content)
        {
            ...
            try
            {
                ...
                foreach (JObject o in ja)
                {
                    ...
                    dr["Content"] = o["AcceptStation"];
                    dr["Time"] = o["AcceptTime"];
                    dt.Rows.Add(dr);
                }
            }
            catch { }
