...
namespace MojoCube.Web.Product
{
    public class Category
    {
        ...
        public void GetData(int id)
        {
            ...
            {
                conn.Open();
                string sql = "select * from Product_Category where pk_Category=@pk_Category";
        ...
        public void GetData(string pageName)
        {
            ...
            {
                conn.Open();
                string sql = "select * from Product_Category where PageName=@PageName";
                SqlCommand comm = new SqlCommand(sql, conn);
        ...
        {
            Sql.SqlQuery("delete from Product_Category where pk_Category=" + id);
        }
